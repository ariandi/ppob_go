...
type Querier interface {
	...
	GetTransactionCount(ctx context.Context, arg GetTransactionCountParams) (GetTransactionCountRow, error)
	...
	ListUserCount(ctx context.Context) (ListUserCountRow, error)
